    ...
    const sampleTasks: Partial<Task>[] = [
      ...
      // II. Wybór Podwykonawców
      {
        ...
        notes: [
          ...
          'Firma: Cozawesele',
          'REZERWACJA JEST POTWIERDZONA - umowa w załączniku',
          'Na około dwa tygodnie przed ślubem skontaktują się w celu ustalenia szczegółów',
        ],
        completed: true,
      ...
      },
      {
        ...
        notes: [
          'Podpisana umowa',
          'Całość 10 000 zł w dniu wesela',
          'Kaucja 1 000 zł zapłacona',
          'Tydzień przed ślubem przekazać informacje o zabawach weselnych',
          'Zagranie pod domem - potwierdzić',
          'Sprawdzić prawa muzyczne w kościele',
        ],
        completed: true,
        category: 'II. Wybór Podwykonawców',
        createdAt: new Date(),
